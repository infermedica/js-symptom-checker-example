...
const template = (context) => {
  return new Promise((resolve) => {
    resolve(`
      ...
      <div class="card-text">
        <p>We created this example to help you work with our API, and show you how to implement a simple symptom checker &mdash; an application that mimics doctor's interview and gives you a diagnosis basing on our mathematical model.</p>
