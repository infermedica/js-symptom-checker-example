  ...
  return new Promise((resolve) => {
    resolve(`
        ...
        <div class="card-text">
          ...
          <p>Visit our <a href="https://github.com/infermedica/python-api">GitHub page</a> to grab the source code of this example as well as a guide on how to start working with it.</p>
