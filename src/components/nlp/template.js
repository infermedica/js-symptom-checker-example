  ...
  return new Promise((resolve) => {
    resolve(html`
      ...
      <div class="card-text">
        ...
        <p class="text-muted small"><i class="fa fa-exclamation-circle"></i> Please note that you can go <span class="badge badge-primary">Next</span> only if there are <span class="text-success">present <i class="fa fa-plus-circle"></i></span> identified observations.</p>
